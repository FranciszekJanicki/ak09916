...
typedef struct {
    void* user;
    ak09916_err_t (*bus_init)(void*);
    ak09916_err_t (*bus_deinit)(void*);
    ak09916_err_t (*bus_write)(void*, uint8_t, uint8_t const*, size_t);
    ak09916_err_t (*bus_read)(void*, uint8_t, uint8_t*, size_t);
} ak09916_interface_t;

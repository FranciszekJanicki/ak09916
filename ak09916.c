...
static ak09916_err_t ak09916_bus_read_data(ak09916_t const *ak09916,
  ...
  return ak09916->interface.bus_read_data
             ? ak09916->interface.bus_read_data(ak09916->interface.user,
                                                address, data, data_size)
             : AK09916_ERR_NULL;
}
...
ak09916_err_t ak09916_get_who_am_1_reg(ak09916_t const *ak09916,
  ...
  ak09916_err_t err = ak09916_bus_read_data(
      ak09916, AK09916_REG_ADDR_WHO_AM_I_1, &data, sizeof(data));
...
ak09916_err_t ak09916_get_who_am_2_reg(ak09916_t const *ak09916,
  ...
  ak09916_err_t err = ak09916_bus_read_data(
      ak09916, AK09916_REG_ADDR_WHO_AM_I_2, &data, sizeof(data));
...
ak09916_err_t ak09916_get_status_1_reg(ak09916_t const *ak09916,
  ...
  ak09916_err_t err = ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_STATUS_1,
                                            &data, sizeof(data));
...
ak09916_err_t ak09916_get_xout_reg(ak09916_t const *ak09916,
  ...
  ak09916_err_t err = ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_XOUT_L,
                                            data, sizeof(data));
...
ak09916_err_t ak09916_get_yout_reg(ak09916_t const *ak09916,
  ...
  ak09916_err_t err = ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_YOUT_L,
                                            data, sizeof(data));
...
ak09916_err_t ak09916_get_zout_reg(ak09916_t const *ak09916,
  ...
  ak09916_err_t err = ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_ZOUT_L,
                                            data, sizeof(data));
...
ak09916_err_t ak09916_get_status_2_reg(ak09916_t const *ak09916,
  ...
  ak09916_err_t err = ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_STATUS_2,
                                            &data, sizeof(data));
...
ak09916_err_t ak09916_get_control_2_reg(ak09916_t const *ak09916,
  ...
  ak09916_err_t err = ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_CONTROL_2,
                                            &data, sizeof(data));
...
ak09916_err_t ak09916_set_control_2_reg(ak09916_t const *ak09916,
  ...
  err |= ak09916_bus_write_data(ak09916, AK09916_REG_ADDR_CONTROL_2, &data,
                                sizeof(data));
...
ak09916_err_t ak09916_get_control_3_reg(ak09916_t const *ak09916,
  ...
  ak09916_err_t err = ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_CONTROL_3,
                                            &data, sizeof(data));
...
ak09916_err_t ak09916_set_control_3_reg(ak09916_t const *ak09916,
  ...
  err |= ak09916_bus_write_data(ak09916, AK09916_REG_ADDR_CONTROL_3, &data,
                                sizeof(data));

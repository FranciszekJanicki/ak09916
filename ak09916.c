...
static ak09916_err_t ak09916_bus_initialize(ak09916_t const* ak09916)
{
    return ak09916->interface.bus_initialize
               ? ak09916->interface.bus_initialize(ak09916->interface.user)
               : AK09916_ERR_NULL;
}

static ak09916_err_t ak09916_bus_deinitialize(ak09916_t const* ak09916)
{
    return ak09916->interface.bus_deinitialize
               ? ak09916->interface.bus_deinitialize(ak09916->interface.user)
               : AK09916_ERR_NULL;
}

static ak09916_err_t ak09916_bus_write_data(ak09916_t const* ak09916,
                                            uint8_t address,
                                            uint8_t const* data,
                                            size_t data_size)
{
    return ak09916->interface.bus_write_data
               ? ak09916->interface.bus_write_data(ak09916->interface.user,
                                                   address,
                                                   data,
                                                   data_size)
               : AK09916_ERR_NULL;
...
static ak09916_err_t ak09916_bus_read_data(ak09916_t const* ak09916,
                                           uint8_t address,
                                           uint8_t* data,
                                           size_t data_size)
{
    return ak09916->interface.bus_read_data
               ? ak09916->interface.bus_read_data(ak09916->interface.user, address, data, data_size)
               : AK09916_ERR_NULL;
}
                                 ...
                                 ak09916_interface_t const* interface)
{
    ...
    return ak09916_bus_initialize(ak09916);
}
...
ak09916_err_t ak09916_deinitialize(ak09916_t* ak09916)
{
    ...
    ak09916_err_t err = ak09916_bus_deinitialize(ak09916);
...
ak09916_err_t ak09916_get_who_am_1_reg(ak09916_t const* ak09916, ak09916_who_am_i_1_reg_t* reg)
{
    ...
    ak09916_err_t err =
        ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_WHO_AM_I_1, &data, sizeof(data));
...
ak09916_err_t ak09916_get_who_am_2_reg(ak09916_t const* ak09916, ak09916_who_am_i_2_reg_t* reg)
{
    ...
    ak09916_err_t err =
        ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_WHO_AM_I_2, &data, sizeof(data));
...
ak09916_err_t ak09916_get_status_1_reg(ak09916_t const* ak09916, ak09916_status_1_reg_t* reg)
{
    ...
    ak09916_err_t err =
        ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_STATUS_1, &data, sizeof(data));
...
ak09916_err_t ak09916_get_xout_reg(ak09916_t const* ak09916, ak09916_xout_reg_t* reg)
{
    ...
    ak09916_err_t err = ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_XOUT_L, data, sizeof(data));
...
ak09916_err_t ak09916_get_yout_reg(ak09916_t const* ak09916, ak09916_yout_reg_t* reg)
{
    ...
    ak09916_err_t err = ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_YOUT_L, data, sizeof(data));
...
ak09916_err_t ak09916_get_zout_reg(ak09916_t const* ak09916, ak09916_zout_reg_t* reg)
{
    ...
    ak09916_err_t err = ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_ZOUT_L, data, sizeof(data));
...
ak09916_err_t ak09916_get_status_2_reg(ak09916_t const* ak09916, ak09916_status_2_reg_t* reg)
{
    ...
    ak09916_err_t err =
        ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_STATUS_2, &data, sizeof(data));
...
ak09916_err_t ak09916_get_control_2_reg(ak09916_t const* ak09916, ak09916_control_2_reg_t* reg)
{
    ...
    ak09916_err_t err =
        ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_CONTROL_2, &data, sizeof(data));
                                        ...
                                        ak09916_control_2_reg_t const* reg)
{
    ...
    err |= ak09916_bus_write_data(ak09916, AK09916_REG_ADDR_CONTROL_2, &data, sizeof(data));
...
ak09916_err_t ak09916_get_control_3_reg(ak09916_t const* ak09916, ak09916_control_3_reg_t* reg)
{
    ...
    ak09916_err_t err =
        ak09916_bus_read_data(ak09916, AK09916_REG_ADDR_CONTROL_3, &data, sizeof(data));
                                        ...
                                        ak09916_control_3_reg_t const* reg)
{
    ...
    err |= ak09916_bus_write_data(ak09916, AK09916_REG_ADDR_CONTROL_3, &data, sizeof(data));
